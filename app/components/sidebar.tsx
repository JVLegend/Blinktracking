          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              ...
              <Link
                ...
                className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 hover:bg-sidebar-accent group
                  ${isActive('/analise/graficos') ? 'bg-primary text-primary-foreground shadow-sm' : 'text-sidebar-foreground hover:text-sidebar-accent-foreground'}`}
              >
                <BarChart3 className="w-5 h-5" />
                <span className="font-medium">Gráficos das Piscadas</span>
              </Link>
              <Link
