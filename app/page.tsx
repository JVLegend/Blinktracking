...
const analysisFeatures = [
  {
    ...
    description: "Algoritmo avançado de Eye Aspect Ratio (6 pontos) para detecção precisa de piscadas.",
  ...
  {
    Icon: BarChart3,
    name: "Gráficos de Piscadas",
    description: "Visualize as curvas de velocidade de fechamento, abertura e amplitudes binoculares em tempo real.",
    href: "/analise/graficos",
    cta: "Ver Gráficos",
    background: <div className="absolute -right-20 -top-20 opacity-60 bg-gradient-to-br from-indigo-500/20 to-transparent w-full h-full" />,
    className: "col-span-3 lg:col-span-1 border-indigo-500/20 bg-indigo-500/5",
  },
  {
    Icon: Move,
    name: "Estabilidade da Cabeça",
    description: "Ferramenta de Scatter Plot para visualizar a dispersão espacial e identificar movimentos indesejados.",
  ...
  },
  {
    ...
    description: "Visualize e exporte os dados brutos de coordenadas para validação técnica e pesquisa.",
