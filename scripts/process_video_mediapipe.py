...
"""
Mapeamento dos pontos do MediaPipe para VISUALIZAÇÃO DO VÍDEO:

IMPORTANTE: Estes pontos são utilizados APENAS para desenhar os landmarks no vídeo processado.
Os pontos extraídos para o CSV são diferentes (ver extract_points_mediapipe.py).

Olho Esquerdo (Visualização):
- Pálpebra Superior: [386, 387, 388, 390, 373, 374, 380]
- Pálpebra Inferior: [386, 385, 384, 398, 382, 381, 380, 374, 373]
- Íris: [474, 475, 476, 477]
- Contorno Completo: [362, 382, 381, 380, 374, 373, 390, 249, 263, 466, 388, 387, 386, 385, 384, 398]

Olho Direito (Visualização):
- Pálpebra Superior: [159, 160, 161, 163, 144, 145, 153]
- Pálpebra Inferior: [159, 158, 157, 173, 155, 154, 153, 145, 144]
- Íris: [469, 470, 471, 472]
...
def main():
    ...
    parser.add_argument('predictor_path', nargs='?', default=None, 
                       help='Caminho do modelo (opcional, não usado no MediaPipe)')
