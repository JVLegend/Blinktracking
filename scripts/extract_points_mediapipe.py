...
def extract_points_from_video(video_path):
    try:
        ...
        # Índices dos pontos dos olhos no MediaPipe Face Mesh
        right_eye_upper = [27, 29, 30, 31, 32, 33, 34]  # Pálpebra superior direita
        right_eye_lower = [35, 36, 37, 38, 39, 40, 41, 42, 43]  # Pálpebra inferior direita
        left_eye_upper = [257, 259, 260, 261, 262, 263, 264]  # Pálpebra superior esquerda
        left_eye_lower = [265, 266, 267, 268, 269, 270, 271, 272, 273]  # Pálpebra inferior esquerda
